***REMOVED***
***REMOVED***
***REMOVED*** Template Name: View Incident
***REMOVED***/
session_start();
...
***REMOVED***if ( ! empty( $_GET['csmi'] ) ) {
***REMOVED******REMOVED***$incident = bigt_csm_get_incident( filter_var( $_GET['csmi'], FILTER_SANITIZE_NUMBER_INT ) );

***REMOVED******REMOVED***$comment_list = bigt_csm_get_incident_comment_list( filter_var( $_GET['csmi'], FILTER_SANITIZE_NUMBER_INT ) );

***REMOVED*** else {
***REMOVED******REMOVED***$incident     = bigt_csm_get_incident( filter_var( $_GET['mbui'], FILTER_SANITIZE_STRING ), 'mbui' );
***REMOVED******REMOVED***$comment_list = false;
***REMOVED***
***REMOVED***
...
***REMOVED******REMOVED******REMOVED***  </div>
***REMOVED******REMOVED***  </div>
***REMOVED******REMOVED******REMOVED*****REMOVED*****REMOVED*** if ( false !== $comment_list ) : ?>
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED*** foreach ( $comment_list->comments as $_comment ) : ?>
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED*** $comment = bigt_csm_get_journal( $_comment->recId ); ?>
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED*** // print('<pre>' . print_r($comment, true) . '</pre>'); ?>
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED*** if ( 'Journal - Mail History' == $comment->JournalTypeName || 'Journal - Note' == $comment->JournalTypeName ) : ?>
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED*** echo $comment->CreatedDateTime; ?>
***REMOVED******REMOVED******REMOVED******REMOVED***  </p>
***REMOVED******REMOVED******REMOVED***  </div>
***REMOVED******REMOVED******REMOVED***  
...
***REMOVED******REMOVED***  </div>
***REMOVED***  </div>
***REMOVED***  <div class="col-md-3">***REMOVED******REMOVED***  
***REMOVED******REMOVED***<h6 style="font-variant:all-small-caps;">Client</h6>
***REMOVED******REMOVED***<p><strong>***REMOVED*** echo $incident->CustomerDisplayName; ?></strong>
***REMOVED******REMOVED***<br>***REMOVED*** echo $incident->Site; ?></p>

***REMOVED******REMOVED***<h6 style="font-variant:all-small-caps;">Technician</h6>
***REMOVED******REMOVED***<p><strong>***REMOVED*** echo $incident->OwnedBy; ?></strong>
***REMOVED******REMOVED***<br>***REMOVED*** echo $incident->OwnedByTeam; ?></p>

***REMOVED******REMOVED***<h6 style="font-variant:all-small-caps;">Last Update</h6>
***REMOVED******REMOVED***<p><strong>***REMOVED*** echo $last_updated_by; ?></strong>
***REMOVED******REMOVED***<br>***REMOVED*** echo $incident->LastModifiedDateTime; ?></p>
***REMOVED***  </div>
***REMOVED***</div><!-- .row -->
